...
const myUserData = "https://api.github.com/users/chrisjcorbin";
...
axios
  ...
  .catch((error) => {
    console.log("This appears to be broken still..." + error);
  });
...
followersArray.forEach((item) => {
  axios
    ...
    .catch((error) => {
      console.log("This appears to be broken again..." + error);
    });
});
    ...
    <div class="card">
      ...
      <div class="card-info">
        ...
        <div class="more-info closed">
            <p class="contact"> Contact: {users email}</p> 
            <p>Repos: 
            <a href = {address to repos page}>{address to users github repos page}</a> 
            </p>
        </div>
      </div>
    </div>
